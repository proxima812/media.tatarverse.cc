...
- [x] Разложить компоненты по назначению и обновить потребителей.
- [x] Собрать данные глоссария одним вызовом и отделить клиентский код.
- [x] Сократить комментарии и проверить изменения.
...
Результат: `bun run check` - 112 файлов, 0 ошибок, предупреждений и подсказок. Старых импортов в src нет. Сборка и браузерная проверка не запускались.
