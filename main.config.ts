...
export const config: AppConfig = {
	...
	indexNow: { enabled: true, key: "dfe4aa4360f13b45a04036849453d45d" },
	...
	site: {
		...
		/** Пусто - и ссылка «предложить правку» на карточках не появится. */
		repository: "https://github.com/proxima812/media.tatarverse.cc",
