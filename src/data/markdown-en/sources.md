---
title: Sources and Trademarks
description: Where the catalog's project data comes from, who owns the logos, and how to report an issue.
...
Each card's name, description, facts, and logo are gathered from public
sources: the project's official site, its social media pages, or public
descriptions. We try to keep information accurate and current, but we're not
...
Logos, names, and other trademarks shown in the cards are the property of
their respective owners. They're used in the catalog solely to identify the
project (nominative use), not as a claim of partnership, sponsorship, or
endorsement by media.tatarverse.
...
does not extend to third-party logos and materials as described above.
