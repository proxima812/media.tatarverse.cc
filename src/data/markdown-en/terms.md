---
title: Terms of Use
description: The terms under which you can use the media.tatarverse catalog and submit projects to it.
...
You're free to browse the catalog, follow links, and share them. You may not:

- automatically scrape the site in a way that places excessive load on the
  server (occasional, reasonable scraping isn't something we chase down);
- attempt to disrupt the site or bypass its protective measures;
- submit, via pull request, projects whose content is illegal, spam, or
  misleading to users.
...
The catalog points to sites and channels we don't control. We're not
responsible for their content, availability, or what happens after you leave
media.tatarverse.

## Disclaimer and limitation of liability

The site is provided "as is", without warranties of any kind: we don't
guarantee uninterrupted operation, that every card is up to date, or that
it's free of errors. To the extent permitted by applicable law,
media.tatarverse and its contributors aren't liable for damages arising from
use of the site.

## Changes to these terms

We may update this text from time to time, for example when adding new site
functionality. The date at the top of the page reflects the last change; the
full edit history is open in the repository.
