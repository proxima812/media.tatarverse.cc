 ...
 *
 * Палитра, хеш, PRNG и кривая светлоты - общие для всех генераторов фона и
 * лежат в `generators/shared.ts`; здесь остается только раскладка блобов.
 * Прочие рисунки (кольца, лучи, плетение, ленты) - там же, рядом.
 *
